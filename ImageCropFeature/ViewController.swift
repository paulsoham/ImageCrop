...
class ViewController: UIViewController {
    ...
    var customImagePickerVC = CustomImagePickerViewController()
...
// MARK: - CustomImagePickerDelegate - (UIImagePickerController) -
extension ViewController: CustomImagePickerDelegate {

    func didSelectLibraryImage(image: UIImage?) {
        self.customImagePickerVC.dismiss(animated: true, completion: { [weak self] in
               guard let self = self else { return }
    ...
    func didCancelLibrarySelection() {
        self.customImagePickerVC.dismiss(animated: true)
    }
